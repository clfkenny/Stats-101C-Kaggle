...
train_data <- na.omit(training[[1]][, c('Fatal','SubjectRace', 'SubjectGender', 'SubjectArmed',
...
set.seed(seed)
rF_mod <- randomForest(Fatal ~., data = train_data_train,ntree=500, mtry=7, importance=T, maxnodes=5)
rF_mod
...
write.csv(test_df, '~/dropbox/stats-101c-kaggle/Submissions/Submission13.csv', row.names=F)
